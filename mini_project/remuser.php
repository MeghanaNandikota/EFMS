                ...
                <div class="col-12 col-sm-8 col-md-6 m-auto">
                    <div class="card border-0 shadow" style="background: transparent;">
                      <div class="card-body" >
                        ...
                        <form  action="confremuser.php" method="post" autocomplete="on" onsubmit="return submitForm(this);"> 

                                <h3 class="text-center py-3" >REMOVE DONOR</h3>
                                <p> 
                                     <h5>Choose Username </h5> 
                                 <select id="un" class="form-control" name="un">
                                  <option value=" ">CHOOSE ▼</option>
                                   <?php $query =mysqli_query($con,"SELECT * FROM user_form");
